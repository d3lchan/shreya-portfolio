      ...
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            ...
            >
              <div className="rounded-lg overflow-hidden shadow-md border-2 border-lavender/20">
                <img 
                  src="/shreya.jpeg" 
                  alt="Shreya" 
          ...
          >
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              <div className="flex items-center bg-lavender/10 px-4 py-2 rounded-full">
                <span className="text-lavender mr-2">
              ...
              <div className="flex items-center bg-pink/10 px-4 py-2 rounded-full">
              ...
              <div className="flex items-center bg-peach/10 px-4 py-2 rounded-full">
                <span className="text-peach mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
