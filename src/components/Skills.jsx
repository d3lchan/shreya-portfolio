...
const Skills = () => {
  const skillCategories = [
    {
      title: "Languages",
      skills: ["Java", "Python", "C/C++", "SQL", "JavaScript", "HTML/CSS", "PHP", "HiveQL", "Pig Latin"]
    },
    {
      title: "Frameworks",
    ...
    {
      title: "Libraries",
      skills: ["Pandas", "NumPy", "Matplotlib", "Scikit-learn", "TensorFlow", "Seaborn", "Plotly", "NLTK", "PySpark"]
    },
    {
      title: "Developer Tools",
      skills: ["Git", "Github", "VS Code", "PyCharm", "Jupyter Notebook", "Jira", "Linux", "Excel", "PowerBi", "Cloudera"]
    }
  ];
