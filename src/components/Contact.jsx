...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: '@https://www.linkedin.com/in/shreya-analyst/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://leetcode.com/u/shreyahhh_/',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Unstop',
      url: 'https://unstop.com/shreya',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-7 18c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6z"/>
        </svg>
      )
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    // Here you would normally send the form data to a backend or email service
    setTimeout(() => {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 border border-gray-200 rounded-md focus:ring-2 focus:ring-pink focus:border-transparent"
                />
              </div>
